...
class Purchase:
    def __init__(self, user):
        self.products = {}  # Словарь для хранения товара и его количества
        self.user = user  # Экземпляр класса User
    ...
    def __str__(self):
        # Формируем строку для отображения заказа
...
assert cart.get_total() == 60, 'Повинно залишаться 60!'
